...
export default {
	...
	meta_info: {
		titleTemplate: "Zion English 자이온 영어",
		meta: [
			{charset: "utf-8"},
			...
			{property: "twitter:title", content: "Learn English with Zion English 자이온 영어"},
