...
export default {
	...
	meta_info: {
		...
		meta: [
			...
			{property: "og:title", content: "Zion English"},
			{property: "og:site_name", content: "Zion English"},
			...
			{property: "twitter:title", content: "Learn English with Zion English"},
